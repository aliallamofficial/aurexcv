...
// رفع الإصدار إلى v6.2 لضمان مسح أيقونات SVG القديمة وتخزين أصول الـ PNG التكيفية الجديدة
const CACHE_NAME = 'aurex-cv-v6.2-cache';
...
const STATIC_ASSETS = [
  ...
  './assets/style.css',
  './assets/logo.svg',       // يُترك للمتصفح الداخلي والهيدر
  './assets/icon-192.png',   // الأيقونة التكيفية الجديدة 192px
  './assets/icon-512.png',   // الأيقونة التكيفية الجديدة 512px
  './js/i18n.js',
  './js/ai.js',
  './js/core.js',
  './js/app.js',
