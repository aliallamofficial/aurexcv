...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // 3️⃣ زر تحميل الـ PDF الحاسم والنهائي
    ...
    if (settingsModal) {
        settingsModal.classList.add("hidden"); // ضمان الإخفاء التلقائي عند أول فتح على الهواتف
    }
    ...
    // 🎨 [ميزة تعدد القوالب والألوان للأشكال في قائمة الإعدادات]
    ...
    // 🌐 [ميزة التبديل للغة الإنجليزية والترجمة الفورية الفاخرة للواجهة بالكامل]
    ...
    if (toggleLanguageBtn) {
        toggleLanguageBtn.addEventListener("click", function () {
            if (currentLang === "ar") {
                ...
                document.getElementById("fullName")?.setAttribute("placeholder", "Your Full Name");
                document.getElementById("jobTitle")?.setAttribute("placeholder", "Target Job Title");
                document.getElementById("experience")?.setAttribute("placeholder", "Your Professional Experience");
                document.getElementById("skills")?.setAttribute("placeholder", "Your Skills (Comma separated)");
            } else {
                currentLang = "ar";
                document.documentElement.dir = "rtl";
                document.documentElement.lang = "ar";
                toggleLanguageBtn.textContent = "🔄 English";
                document.getElementById("fullName")?.setAttribute("placeholder", "الاسم الكامل");
                document.getElementById("jobTitle")?.setAttribute("placeholder", "المسمى الوظيفي المستهدف");
                document.getElementById("experience")?.setAttribute("placeholder", "الخبرات والمهام العملية المهنية...");
                document.getElementById("skills")?.setAttribute("placeholder", "المهارات (افصل بينها بفاصلة ,)");
            }
        });
    }

    // 🧠 [ميزة توليد الملخص المهني التلقائي الفوري والمقنع بناءً على المعطيات]
    const generateSummaryBtn = document.getElementById("generateSummaryBtn");
    if (generateSummaryBtn) {
        generateSummaryBtn.addEventListener("click", function () {
            const jobTitle = document.getElementById("jobTitle")?.value.trim() || "المتخصص المهني";
            const skills = document.getElementById("skills")?.value.trim() || "المهارات والقدرات المتقدمة";
            
            if (resultBox) {
                const summaryText = `<strong>[الملخص المهني / Professional Summary]</strong><br>متخصص شغوف ومحترف في مجال ${jobTitle}، أمتلك مهارات قوية تغطي (${skills}). ملتزم بالعمل وفق أعلى المعايير القياسية العالمية والمساهمة الفعالة في دفع عجلة نمو المؤسسة وتخطي أهداف نظام الفلترة الـ ATS بنجاح وكفاءة عمل عالية.<br><br>`;
                resultBox.innerHTML = summaryText + resultBox.innerHTML;
                if(downloadContainer) downloadContainer.classList.remove('hidden');
                alert("🎉 تم توليد الملخص المهني المخصص وحقنه في بداية صندوق السيرة الذاتية بنجاح!");
            }
        });
    }
